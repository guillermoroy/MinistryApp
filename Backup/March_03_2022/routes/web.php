...
Route::group(['middleware'=>['AuthCheck']], function(){
    ...
    Route::get('/auth/myprofile/{id}',[MainController::class, 'update_myprofile'])->name('auth.update_myprofile');
   ...
   // Route::get('/auth/update_monthly/{id}',[MinistryMonthly::class, 'update_monthly'])->name('auth.update_monthly');
    ...
    //
    Route::get('/auth/select_report',[MinistryMonthly::class, 'select_report'])->name('auth.select_report');
    //
    Route::get('/auth/service_month_report',[MinistryDaily::class, 'service_month_report'])->name('auth.service_month_report');

    //final submission
    Route::get('/auth/final_month',[MinistryDaily::class, 'final_month'])->name('auth.final_month');
