...
<div class="modal modal-slide-in fade" id="modals-daily-slide-in">
    <div class="modal-dialog sidebar-sm">
        <form class="add-new-record modal-content pt-0" action="{{ route('auth.create_daily', session()->get('LoggedUserID')) }}" method="GET" >
            ...
            <div class="mb-1">
            <label class="form-label" for="contact-info-icon">Date Today</label>
                    <div class="input-group input-group-merge">
                        <span class="input-group-text"><i data-feather="share"></i></span>
                        <input type="number"  class="form-control"  id="datenow" name="datenow"  readonly>
                    </div>            
            </div>               
            ...
            <label class="form-label" for="contact-info-icon">Number Of Placement</label>
                ...
                <button type="submit" class="btn btn-primary me-1" id="btnMothly" data-bs-dismiss="modal">Update</button>
