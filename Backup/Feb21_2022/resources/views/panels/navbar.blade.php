                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="#">
                  <i data-feather="file-text"></i><span class="menu-title text-truncate" data-i18n="Invoice">Field Service</span></a>
                    <ul class="menu-content">
                        ...
                        <i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="List">Daily Service</span></a></li>
                        ...
                        <i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="List">Monthly Service</span></a></li>
