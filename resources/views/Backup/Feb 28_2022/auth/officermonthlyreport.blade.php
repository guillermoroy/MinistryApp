                            ...
                            <div class="card">
                                ...
                                <div class="card shadow-none border-0 mb-0 rounded-0">
                                    <div class="card-body pb-0">
                                       Color Legend:
                                        <button type="button" class="btn btn-flat-warning">Pioner: Orange</button>
                                        <button type="button" class="btn btn-flat-success">Auxiliary: Green</button>
                                    </div>
                                  </div>
                                </div>      
                                ...
                                <table class="datatables-basic1 table">
                                    ...
                                    <td> {{ $service->fullname }}   @php   echo $ptype;   @endphp </td>
