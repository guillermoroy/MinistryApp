<div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class="nav-item {{ (request()->is('auth/onlinecom/0*')) ? 'active' : '' }}">
                ...
                <li class="nav-item {{ (request()->is('auth/onlinecom/4*')) ? 'active' : '' }}">
                    <a class="d-flex align-items-center" href="{{ route('auth.onlinecom',['ptypeid'=>4,'filterid'=>3]) }}"><i class="material-icons">group</i>
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="#">
                  <i data-feather="file-text"></i><span class="menu-title text-truncate" data-i18n="Invoice">Field Service</span></a>
                    <ul class="menu-content">
                        ...
                        <i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="List">Daily Calendar  </span></a></li>

                        <!--li class="{{ (request()->is('auth/index_day*')) ? 'active' : '' }}">
                            <a class="d-flex align-items-center" href="{{ route('auth.dataentrydaily') }}">
                        <i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="List">Daily Input</span></a></li-->


                        <li class="{{ (request()->is('auth/service_report*')) ? 'active' : '' }}">
                            <a class="d-flex align-items-center" href="{{ route('auth.servicereport') }}">
                        <i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="List">Service Report</span></a></li>
                        ...
                        if($ulevel==99){
                        @endphp   
                        <li class="{{ (request()->is('auth/officer_report*')) ? 'active' : '' }}">
                            <a class="d-flex align-items-center" href="{{ route('auth.officer_report') }}">
                ...
                <li class=" navigation-header"><span data-i18n="Apps &amp; Pages">Forms &amp; Template</span><i data-feather="more-horizontal"></i>
                </li>
